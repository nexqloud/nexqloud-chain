...
// HalvingData tracks the current halving period and epoch progression
type HalvingData struct {
	// current_period indicates which halving period we're in (0, 1, 2, ...)
	CurrentPeriod uint64 `protobuf:"varint,1,opt,name=current_period,json=currentPeriod,proto3" json:"current_period,omitempty"`
	// last_halving_epoch stores the epoch number when the last halving occurred
	LastHalvingEpoch uint64 `protobuf:"varint,2,opt,name=last_halving_epoch,json=lastHalvingEpoch,proto3" json:"last_halving_epoch,omitempty"`
	// start_epoch stores the epoch number when halving system was initialized
	StartEpoch uint64 `protobuf:"varint,3,opt,name=start_epoch,json=startEpoch,proto3" json:"start_epoch,omitempty"`
}

func (m *HalvingData) Reset()         { *m = HalvingData{} }
func (m *HalvingData) String() string { return proto.CompactTextString(m) }
func (*HalvingData) ProtoMessage()    {}
func (*HalvingData) Descriptor() ([]byte, []int) {
	return fileDescriptor_d064cb35c3ff7df8, []int{2}
}
func (m *HalvingData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HalvingData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HalvingData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HalvingData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HalvingData.Merge(m, src)
}
func (m *HalvingData) XXX_Size() int {
	return m.Size()
}
func (m *HalvingData) XXX_DiscardUnknown() {
	xxx_messageInfo_HalvingData.DiscardUnknown(m)
}

var xxx_messageInfo_HalvingData proto.InternalMessageInfo

func (m *HalvingData) GetCurrentPeriod() uint64 {
	if m != nil {
...
func (m *HalvingData) GetLastHalvingEpoch() uint64 {
	if m != nil {
		return m.LastHalvingEpoch
	}
	return 0
}

func (m *HalvingData) GetStartEpoch() uint64 {
	if m != nil {
		return m.StartEpoch
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*HalvingData)(nil), "evmos.inflation.v1.HalvingData")
}
...
var fileDescriptor_d064cb35c3ff7df8 = []byte{
	...
	,
}
...
func (m *HalvingData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HalvingData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HalvingData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.StartEpoch != 0 {
		i = encodeVarintInflation(dAtA, i, uint64(m.StartEpoch))
		i--
		dAtA[i] = 0x18
	}
	if m.LastHalvingEpoch != 0 {
		i = encodeVarintInflation(dAtA, i, uint64(m.LastHalvingEpoch))
		i--
		dAtA[i] = 0x10
	}
	if m.CurrentPeriod != 0 {
		i = encodeVarintInflation(dAtA, i, uint64(m.CurrentPeriod))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *HalvingData) Size() (n int) {
	...
	_ = l
	if m.CurrentPeriod != 0 {
		n += 1 + sovInflation(uint64(m.CurrentPeriod))
	}
	if m.LastHalvingEpoch != 0 {
		n += 1 + sovInflation(uint64(m.LastHalvingEpoch))
	}
	if m.StartEpoch != 0 {
		n += 1 + sovInflation(uint64(m.StartEpoch))
	}
	return n
}
...
func (m *HalvingData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HalvingData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HalvingData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastHalvingEpoch", wireType)
			}
			m.LastHalvingEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowInflation
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastHalvingEpoch |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
